...
## 第一阶段：本机冒烟（已完成，见 results/table.md）

| 模型 | 方法 | 设置 | 状态 |
|---|---|---|---|
| Qwen2.5-0.5B | dense | fp16, wikitext2 PPL | ✅ |
| Qwen2.5-0.5B | Wanda | 50% 非结构化 | ✅ |
| Qwen2.5-0.5B | Magnitude | 50%（对照） | ✅ |
| Qwen2.5-0.5B | RTN | W4 g128 / W8 g128 | ✅ |
